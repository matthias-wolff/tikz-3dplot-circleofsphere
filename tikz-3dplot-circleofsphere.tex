...
drawing circles of spheres is to compute which part is on the back side of the
...
\begin{figure}[htp]
  ...
  \begin{tikzpicture}[tdplot_main_coords]
    ...
    \end{scope}
    \tdplotCsDrawCircleOfSphere[thick,OrangeRed,tdplotCsFill/.style={opacity=0.1}]{\r}{\alp}{\bet}{\eps}
  \end{tikzpicture}
